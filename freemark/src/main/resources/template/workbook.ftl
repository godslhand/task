...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office"
    ...
    <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        <Revision>1</Revision>
        <Created>2016-11-21T12:36:35Z</Created>
        <LastSaved>2016-12-19T07:28:59Z</LastSaved>
    </DocumentProperties>
    ...
    <Styles>
        ...
        <Style ss:ID="s49"/>
        <Style ss:ID="s50">
            <Font ss:FontName="宋体" x:CharSet="0" x:Family="Swiss" ss:Size="10"/>
        </Style>
        <Style ss:ID="s51">
            <NumberFormat ss:Format="Short Date"/>
        </Style>
    </Styles>
    <Worksheet ss:Name="new sheet">
        <Table ss:ExpandedColumnCount="10" ss:ExpandedRowCount="2" x:FullColumns="1" x:FullRows="1"
               ss:DefaultColumnWidth="48" ss:DefaultRowHeight="12.75">
            <Column ss:Index="1" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="67.5"/>
            <Column ss:Index="2" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="80.25"/>
            <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="58.5"/>
            <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="81"/>
            <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="105.75"/>
            <Column ss:Index="8" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="92.25"/>
            <Row>
                <Cell>
                    <Data ss:Type="String">项目编号</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">子任务编号</Data>
                </Cell>
                <Cell>
                ...
                <Cell>
                    <Data ss:Type="String">完成时限</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">发布人</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">任务状态</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">任务接收人</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">内容</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">提交时间</Data>
                </Cell>
            </Row>
            <#list list as vo>
            <Row>
                <Cell>
                    <Data ss:Type="Number">${vo.projectId}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="Number">${vo.missionId}</Data>
                </Cell>
                <Cell ss:StyleID="s50">
                    <Data ss:Type="String">${vo.projectName}</Data>
                </Cell>
                <Cell ss:StyleID="s50">
                    <Data ss:Type="String">${vo.missionName}</Data>
                </Cell>
                <Cell ss:StyleID="s51">
                    <Data ss:Type="Number">42716</Data>
                </Cell>
                <Cell ss:StyleID="s50">
                    <Data ss:Type="String">${vo.reporter}</Data>
                </Cell>
                <Cell ss:StyleID="s50">
                    <Data ss:Type="String">审核中</Data>
                </Cell>
                <Cell>
        ...
        <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R2C10</RangeSelection>
                </Pane>
            </Panes>
